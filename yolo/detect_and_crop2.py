...
def binary_order(dictionary, place):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                object_coordinates_ord = {}
                if old_img_h > old_img_w:
                    object_coordinates_ord = binary_order(object_coordinates, 3)
                elif old_img_w > old_img_h:
                    object_coordinates_ord = binary_order(object_coordinates, 0)
                else:
                    object_coordinates_ord = binary_order(object_coordinates, 3)
                ...
                for nro_imagen, coordenadas in object_coordinates_ord.items():
                    ...
                    crop_file_path = os.path.join("crop",str(nro_imagen)+".jpg")
...
if __name__ == '__main__':
    ...
    print(opt)
    opt.weights = 'yolo/best.pt'
    opt.source = './imgEnt2'
    print(opt.source, 'AAAAAAAAAAAAAAAAAAAAAAAAAA')
    #check_requirements(exclude=('pycocotools', 'thop'))
    # opt.weights = "C:/Users/Admin/Documents/Universidad/testIA/yolo/best.pt"
    # opt.source = "C:/Users/Admin/Documents/Universidad/testIA/tiraReaccionada/1.jpeg"
    with torch.no_grad():
